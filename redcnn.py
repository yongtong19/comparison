...
class RED_CNN(nn.Module):
    def __init__(self, hid_channels=48, kernel_size=5, padding=2):
        ...
        self.conv_1 = nn.Conv2d(
            1, hid_channels, kernel_size=kernel_size, padding=padding
        )
        self.conv_2 = nn.Conv2d(
            hid_channels, hid_channels, kernel_size=kernel_size, padding=padding
        )
        ...
        self.conv_t_5 = nn.ConvTranspose2d(
            hid_channels, 1, kernel_size=kernel_size, padding=padding
        )
